...
Model package name: Motion_Classification_-_Continuo
Model version: 162
Edge Impulse SDK version: v1.92.7
...
Check if the revision of the `edge-impulse-sdk-zephyr` module in your manifest file matches with the one needed for this model which is v1.92.7.
